   ...
   return (
     ...
     <ScrollView style={styles.mainView}>
       ...
       {/* <View style={styles.Banner}>
           ...
           <ImageBackground imageStyle={{ borderRadius: 12, height:180}}   style={styles.reduceImage2} source={require("C:/Users/Arsal/ProThenics_Nofal/weighted-pull-ups.jpg")}>  
     ...
     <TouchableOpacity style={styles.equip3}> 
         ...
         <ImageBackground  imageStyle={{ borderRadius: 12}}  style={styles.reduceImage3} source={require("C:/Users/Arsal/ProThenics_Nofal/Weighted-Dips.jpg")}>  
     ...
     <TouchableOpacity style={styles.equip4}> 
         ...
         <ImageBackground  imageStyle={{ borderRadius: 12}}  style={styles.reduceImage3} source={require("C:/Users/Arsal/ProThenics_Nofal/squatsweight.jpg")}>  
