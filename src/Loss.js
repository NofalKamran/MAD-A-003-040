   ...
   return (
     ...
     <ScrollView style={styles.mainView}>
       ...
       {/* <View style={styles.Banner}>
           ...
           <ImageBackground imageStyle={{ borderRadius: 12, height:180}}   style={styles.reduceImage2} source={require("C:/Users/Arsal/ProThenics_Nofal/burpee.jpg")}>  
           
           <Text style={styles.titleEquip}>Burpees</Text> 
           
       </ImageBackground>
           </TouchableOpacity>
     <TouchableOpacity style={{margin:20, marginTop:10}} > 
          
         <ImageBackground imageStyle={{ borderRadius: 12, height:180}}   style={styles.reduceImage2} source={require("C:/Users/Arsal/ProThenics_Nofal/chest.jpg")}>  
           
           <Text style={styles.titleEquip}>Pushups</Text> 
     ...
     <TouchableOpacity style={styles.equip3}> 
         ...
         <ImageBackground  imageStyle={{ borderRadius: 12}}  style={styles.reduceImage3} source={require("C:/Users/Arsal/ProThenics_Nofal/plank.jpg")}>  
           
           <Text style={styles.titleEquip3}>Plank</Text> 
     ...
     <TouchableOpacity style={styles.equip4}> 
         ...
         <ImageBackground  imageStyle={{ borderRadius: 12}}  style={styles.reduceImage3} source={require("C:/Users/Arsal/ProThenics_Nofal/crunches.jpg")}>  
           
           <Text style={styles.titleEquip3}>Crunches</Text> 
